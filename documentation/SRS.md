...
Tuning HUB – desktop приложение для персональных компьютеров, работающих на ОС Windows,а конкретно Windows 7,8,10. Приложение предназначено для помощи пользователям и структурирования информации для них в поиске автомобильных запасных частей.
Отлично, у меня как раз есть версия Windows 3.11 на дискетах, и если ваше приложение на ней не запустится то придется вернуть деньги за разработку. Ну а у меня конечно же останется бесплатное для меня приложение.
